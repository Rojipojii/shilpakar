...
function insertData($conn, $fullName, $mobileNumber, $email, $designation, $organization, $event_id = null, $category_id = null, $organizer_id = null)
{
    ...
    if ($event_id !== null && $category_id !== null && $organizer_id !== null) {
        $sql = "INSERT INTO subscribers (full_name, mobile_number, email, designation, organization, event_id, category_id, organizer_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        $stmt->bind_param("ssssiiii", $fullName, $mobileNumber, $email, $designation, $organization, $event_id, $category_id, $organizer_id);
    } else {
        // Use a different SQL statement and bind only five parameters
        $sql = "INSERT INTO subscribers (full_name, mobile_number, email, designation, organization) VALUES (?, ?, ?, ?, ?)";
        $stmt = $conn->prepare($sql);
        ...
        $stmt->bind_param("sssss", $fullName, $mobileNumber, $email, $designation, $organization);
    }
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["Submit"])) {
    ...
    if (insertData($conn, $fullName, $mobileNumber, $email, $designation, $organization, null, $category_id, null)) {
        ...
        <tr>
            ...
            <td class="event-list">
                ...
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    <input type="submit" name="AddSubscribers" value="Add Subscribers" class="btn btn-outline-success"><br><br>
                </form>
